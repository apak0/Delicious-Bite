  ...
  const features = [
    {
      ...
      title: 'Quick Service',
      description: 'From kitchen to table in under 20 minutes. We value your time.'
    },
    {
  ...
  return (
    <main>
      ...
      <section className="relative">
        ...
        <div className="h-[500px] bg-cover bg-center" style={{ backgroundImage: "url('https://images.pexels.com/photos/67468/pexels-photo-67468.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')" }}></div>
        <div className="absolute inset-0 flex items-center z-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-lg">
              <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-6xl">
                Delicious Food, <span className="text-red-600">Delivered Fast</span>
              </h1>
              <p className="mt-4 text-xl text-gray-300">
                Experience the best flavors in town with our chef-prepared meals made from fresh ingredients.
              </p>
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                ...
                <Link to="/track-order">
                  <Button variant="outline" className="bg-white bg-opacity-10 hover:bg-opacity-20 sm:w-auto w-full">
                    Track Your Order
                  </Button>
                </Link>
              </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
              Loved by our customers and crafted with care by our expert chefs.
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Dish 1 */}
            <div className="rounded-lg overflow-hidden shadow-md transition-transform duration-300 hover:-translate-y-2">
              <div className="relative h-64">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4">
                  <h3 className="text-white text-xl font-bold">Margherita Pizza</h3>
            ...
            <div className="rounded-lg overflow-hidden shadow-md transition-transform duration-300 hover:-translate-y-2">
              <div className="relative h-64">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4">
                  <h3 className="text-white text-xl font-bold">Cheeseburger</h3>
                  <p className="text-gray-300">$10.99</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-lg overflow-hidden shadow-md transition-transform duration-300 hover:-translate-y-2">
              <div className="relative h-64">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4">
                  <h3 className="text-white text-xl font-bold">Chicken Alfredo Pasta</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 mb-4">
                "The food was absolutely delicious! Fast delivery and the order was exactly as requested. Will definitely order again!"
              </p>
              <div className="mt-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 mb-4">
                "Best pizza in town! The crust is perfect and the toppings are fresh. Their online ordering system is also very convenient."
              </p>
              <div className="mt-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 mb-4">
                "Great food and reasonable prices. The ability to track my order in real-time was a nice touch. Highly recommend their burgers!"
              </p>
              <div className="mt-4">
