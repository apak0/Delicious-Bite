    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-4 text-center">
          ...
          <p className="text-2xl font-bold text-gray-900">{orderCounts.pending || 0}</p>
        </div>
        
        <div className="bg-white rounded-lg shadow p-4 text-center">
          <p className="text-orange-500 text-sm">Preparing</p>
          <p className="text-2xl font-bold text-gray-900">{orderCounts.preparing || 0}</p>
        </div>
        
        <div className="bg-white rounded-lg shadow p-4 text-center">
          <p className="text-red-600 text-sm">Ready</p>
          <p className="text-2xl font-bold text-gray-900">{orderCounts.ready || 0}</p>
        </div>
        
        <div className="bg-white rounded-lg shadow p-4 text-center">
          <p className="text-green-500 text-sm">Delivered</p>
          <p className="text-2xl font-bold text-gray-900">{orderCounts.delivered || 0}</p>
        </div>
      </div>
      ...
      {filteredOrders.length > 0 ? (
        ...
        <div className="bg-white rounded-lg shadow p-8 text-center">
          <h2 className="text-lg font-medium text-gray-900 mb-1">No orders found</h2>
