          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <ol className="list-decimal pl-5 space-y-2">
              <li className="text-gray-700">
                Enter your order ID in the field above. You can find your order
                ID in the confirmation email you received.
              </li>
              <li className="text-gray-700">
                Click on "Track Order" to see the status of your order.
              </li>
              <li className="text-gray-700">
                You'll be able to see if your order is being prepared, ready for
                pickup, or has been delivered.
              </li>
            </ol>
            <p className="mt-4 text-gray-500 text-sm">
              If you're having trouble finding your order, please contact our
              customer support at (123) 456-7890.
            </p>
          </div>
        )}
      </div>
